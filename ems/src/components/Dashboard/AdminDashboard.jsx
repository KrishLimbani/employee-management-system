                  ...
                  <tbody className="divide-y divide-gray-100">
                    <tr className="hover:bg-gray-50">
                      <td className="px-6 py-4">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-500">EMP-102</p>
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4 text-gray-700">Project Manager</td>
                      <td className="px-6 py-4 text-gray-700">Operations</td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4 text-right space-x-2">
                        <button className="text-xs px-3 py-1 rounded-lg border border-gray-200 hover:bg-gray-50">
                          View
                        </button>
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-500">EMP-089</p>
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4 text-gray-700">Software Engineer</td>
                      <td className="px-6 py-4 text-gray-700">Engineering</td>
                      <td className="px-6 py-4">
                    ...
                    <tr className="hover:bg-gray-50">
                      <td className="px-6 py-4">
                        <div className="flex items-center space-x-3">
                          <div className="h-8 w-8 rounded-full bg-rose-600 text-white flex items-center justify-center text-xs font-semibold">
                            AM
                          </div>
                          <div>
                            <p className="font-medium text-gray-900">Anita Mehta</p>
                            <p className="text-xs text-gray-500">EMP-076</p>
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4 text-gray-700">HR Executive</td>
                      <td className="px-6 py-4 text-gray-700">Human Resources</td>
                      <td className="px-6 py-4">
                        <span className="px-2 py-1 text-xs rounded-full bg-green-100 text-green-800">
                          Active
                        </span>
